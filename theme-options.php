...
function ct_unlimited_register_theme_page(){
	add_theme_page( 'Apex Dashboard', 'Apex Dashboard', 'edit_theme_options', 'unlimited-options', 'ct_unlimited_options_content', 'ct_unlimited_options_content');
}
...
function ct_unlimited_options_content(){
	...
	<div id="unlimited-dashboard-wrap" class="wrap">
		<h2><?php _e('Apex Dashboard', 'unlimited'); ?></h2>
		<?php hybrid_do_atomic( 'theme_options_before' ); ?>
		<div class="content content-customization">
			<h3><?php _e('Customization', 'unlimited'); ?></h3>
			<p><?php _e('Click the "Customize" link in your menu, or use the button below to get started customizing Apex', 'unlimited'); ?>.</p>
			<p>
		...
		<div class="content content-support">
			...
			<p><?php _e("You can find the knowledgebase, changelog, support forum, and more in the Apex Support Center", "unlimited"); ?>.</p>
			<p>
		...
		<div class="content content-premium-upgrade">
			<h3><?php _e('Upgrade to Apex Pro', 'unlimited'); ?></h3>
			<p><?php _e('Apex Pro is the premium upgrade for Apex. It has custom colors, new layouts, background images, and more', 'unlimited'); ?>...</p>
			<p>
