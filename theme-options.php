...
function ct_apex_register_theme_page() {
	add_theme_page( sprintf( esc_html__( '%s Dashboard', 'apex' ), wp_get_theme() ), sprintf( esc_html__( '%s Dashboard', 'apex' ), wp_get_theme() ), 'edit_theme_options', 'apex-options', 'ct_apex_options_content', 'ct_apex_options_content' );
}
	...
	<div id="apex-dashboard-wrap" class="wrap apex-dashboard-wrap">
		...
		<div class="main">
			...
			<div class="getting-started">
				...
				<a href="https://www.competethemes.com/help/getting-started-apex/" target="_blank">Read the Getting Started Guide</a>
			</div>
			<div class="pro">
				<h3>Customize More with Apex Pro</h3>
				<p>Add 10 new customization features to your site with the <a href="<?php echo $pro_url; ?>" target="_blank">Apex Pro</a> plugin.</p>
				<ul class="feature-list">
					<li>
						...
						<div class="text">
							...
							<p>Apex Pro adds 7 new layouts.</p>
						</div>
					</li>
					<li>
						<div class="image">
						...
						<div class="text">
							...
							<p>With 50 color controls, you can change the color of any element on your site.</p>
						</div>
					</li>
					<li>
						<div class="image">
						...
						<div class="text">
							...
							<p>Since Apex Pro is powered by Google Fonts, it comes with 728 fonts for you to choose from.</p>
						</div>
					</li>
					<li>
						<div class="image">
					...
					<li>
						...
						<div class="text">
							...
							<p>Apex Pro auto-embeds videos from Youtube, Vimeo, DailyMotion, Flickr, Animoto, TED, Blip, Cloudup, FunnyOrDie, Hulu, Vine, WordPress.tv, and VideoPress.</p>
						</div>
					</li>
					<li>
						<div class="image">
						...
						<div class="text">
							...
							<p>Apex Pro integrates with the free Meta Slider plugin with styling and sizing controls for your sliders.</p>
						</div>
					</li>
					<li>
						<div class="image">
						...
						<div class="text">
							...
							<p>Apex Pro includes twelve different aspect ratios for your Featured Images.</p>
						</div>
					</li>
					<li>
						<div class="image">
						...
						<div class="text">
							...
							<p>Apex Pro adds 4 new widget areas.</p>
						</div>
					</li>
					<li>
						<div class="image">
						...
						<div class="text">
							...
							<p>Apex Pro includes display controls for 10 different elements.</p>
						</div>
					</li>
					<li>
						<div class="image">
				...
				<p><a href="<?php echo $pro_url; ?>" target="_blank">Click here</a> to view Apex Pro now, and see what it can do for your site.</p>
			</div>
			<div class="pro-ad" style="background-image: url(<?php echo trailingslashit(get_template_directory_uri()) . 'assets/images/bg-texture.png'; ?>)">
				...
				<p>Start customizing with Apex Pro today</p>
				<a href="<?php echo $pro_url; ?>" target="_blank">View Apex Pro</a>
			</div>
			<?php endif; ?>
		</div>
		<div class="sidebar">
			<div class="dashboard-widget">
				...
				<ul>
					<li><a href="https://www.competethemes.com/documentation/apex-support-center/" target="_blank">Apex Support Center</a></li>
					<li><a href="https://wordpress.org/support/theme/apex" target="_blank">Support Forum</a></li>
					<li><a href="https://www.competethemes.com/help/apex-changelog/" target="_blank">Changelog</a></li>
					<li><a href="https://www.competethemes.com/help/apex-css-snippets/" target="_blank">CSS Snippets</a></li>
					<li><a href="https://www.competethemes.com/help/child-theme-apex/" target="_blank">Starter child theme</a></li>
					<li><a href="https://www.competethemes.com/help/apex-demo-data/" target="_blank">Apex demo data</a></li>
			...
			<div class="dashboard-widget">
				...
				<p>Users are loving Apex! <a href="https://wordpress.org/support/theme/apex/reviews/?filter=5#new-post" target="_blank">Click here</a> to leave your own review</p>
			</div>
			<div class="dashboard-widget">
				<h4>Reset Customizer Settings</h4>
				<p><b>Warning:</b> Clicking this buttin will erase the Apex theme's current settings in the Customizer.</p>
				<form method="post">
