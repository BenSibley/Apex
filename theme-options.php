...
function ct_apex_options_content() {
	...
	<div id="apex-dashboard-wrap" class="wrap">
		...
		<div class="content content-customization">
			...
			<p><?php _e( 'Click the "Customize" link in your menu, or use the button below to get started customizing Apex', 'apex' ); ?>
				.</p>
		...
		<div class="content content-support">
			...
			<p><?php _e( "You can find the knowledgebase, changelog, support forum, and more in the Apex Support Center", "apex" ); ?>
				.</p>
		...
		<div class="content content-premium-upgrade">
			...
			<p><?php _e( 'Download the Apex Pro plugin and unlock custom colors, new layouts, a flexible header image, and more', 'apex' ); ?>
				...</p>
		...
		<div class="content content-resources">
			...
			<p><?php _e( 'Save time and money searching for WordPress products by following our recommendations', 'apex' ); ?>
				.</p>
